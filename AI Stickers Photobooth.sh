...
download_if_not_exist "$BASE_PATH/loras/alimama-creative-FLUX.1-Turbo-Alpha.safetensors" "https://huggingface.co/artificialguybr/StickersRedmond/resolve/main/StickersRedmond.safetensors"

download_if_not_exist "$BASE_PATH/checkpoints/dreamshaperXL_lightningDPMSDE.safetensors" "https://civitai.com/api/download/models/354657?type=Model&format=SafeTensor&size=full&fp=fp16"

download_if_not_exist "$BASE_PATH/loras/cartoon.pt" "https://sliders.baulab.info/weights/xl_sliders/cartoon_style.pt"

download_if_not_exist "$BASE_PATH/loras/smiling.pt" "https://sliders.baulab.info/weights/xl_sliders/smiling.pt"
